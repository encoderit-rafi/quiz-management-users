...
export default function AnswerCard({
  ...
  return (
    <div
      className={cn(
        'cursor-pointer border  px-2 md:px-5 py-2 md:py-4 rounded-xl flex items-center gap-4 justify-between transition-all duration-200',
        isSelected
    ...
    >
      ...
      <div
        className={cn(
          'size-10 md:size-12 shrink-0 rounded-full bg-white/10 p-1 flex items-center justify-center duration-200 transition-all',
